...
`define IP_UUID _0f386f34db494fc6b5f72874c5af3eda
`define IP_NAME_CONCAT(a,b) a``b
`define IP_MODULE_NAME(name) `IP_NAME_CONCAT(name,`IP_UUID)
module asfifo_efx #
(
    parameter                           FPGA_DEV = "EL_TI"          ,
...
localparam MODE = (RD_AS_ACK == "TRUE") ? "FWFT" : "STANDARD";
localparam FAMILY = (FPGA_DEV == "EL_TI") ? "TITANIUM" : "TRION";
localparam PAB_DW = (PA_DW > PB_DW) ? PA_DW/PB_DW : PB_DW/PA_DW;
localparam ASYM_WIDTH_RATIO =  (PAB_DW == 1)                     ? 4 : 
                              ((PA_DW > PB_DW) && (PAB_DW == 2)) ? 3 :
                              ((PA_DW > PB_DW) && (PAB_DW == 4)) ? 2 :
                              ((PA_DW > PB_DW) && (PAB_DW == 8)) ? 1 :
                              ((PA_DW > PB_DW) && (PAB_DW == 16))? 0 :
                              ((PA_DW < PB_DW) && (PAB_DW == 2)) ? 5 :
                              ((PA_DW < PB_DW) && (PAB_DW == 4)) ? 6 :
                              ((PA_DW < PB_DW) && (PAB_DW == 8)) ? 7 :
                              ((PA_DW < PB_DW) && (PAB_DW == 16))? 8 : 4;

`IP_MODULE_NAME(efx_fifo_top) #(
    .SYNC_CLK                       (0                          ), 
    .SYNC_STAGE                     (PIPLI_STAGE                ), 
    .DATA_WIDTH                     (PA_DW                      ), 
    .MODE                           (MODE                       ), 
    .OUTPUT_REG                     (0                          ), 
